...
var ApplyRedirects = class {
  ...
  applyRedirectCommands(segments, redirectTo, posParams, currentSnapshot, injector) {
    return getRedirectResult(redirectTo, currentSnapshot, injector).pipe((0, import_operators.map)((redirect) => {
...
function getRedirectResult(redirectTo, currentSnapshot, injector) {
  if (typeof redirectTo === "string") {
    return (0, import_rxjs.of)(redirectTo);
  }
...
This is currently a dev mode only error but will become a call stack size exceeded error in production in a future major version.`);
    ...
    return newTree$.pipe((0, import_operators.switchMap)((newTree) => this.applyRedirects.lineralizeSegments(route, newTree)), (0, import_operators.mergeMap)((newSegments) => {
...
var RouterConfigLoader = class _RouterConfigLoader {
  ...
  loadComponent(injector, route) {
    ...
    const loadRunner = wrapIntoObservable(runInInjectionContext(injector, () => route.loadComponent())).pipe((0, import_operators.map)(maybeUnwrapDefaultExport), (0, import_operators.switchMap)(maybeResolveResources), (0, import_operators.tap)((component) => {
...
function loadChildren(route, compiler, parentInjector, onLoadEndListener) {
  return wrapIntoObservable(runInInjectionContext(parentInjector, () => route.loadChildren())).pipe((0, import_operators.map)(maybeUnwrapDefaultExport), (0, import_operators.switchMap)(maybeResolveResources), (0, import_operators.mergeMap)((t) => {
...
function createViewTransition(injector, from3, to) {
...
var NavigationTransitions = class _NavigationTransitions {
   ...
   */
  transitionAbortWithErrorSubject = new import_rxjs.Subject();
  ...
  setupNavigations(router) {
    this.transitions = new import_rxjs.BehaviorSubject(null);
    return this.transitions.pipe(
      (0, import_operators.filter)((t) => t !== null),
      ...
      (0, import_operators.switchMap)((overallTransitionState) => {
        ...
        return (0, import_rxjs.of)(overallTransitionState).pipe(
          ...
          switchTap((t) => {
            const loadComponents = (route) => {
              ...
              if (route.routeConfig?.loadComponent) {
                ...
                loaders.push(this.configLoader.loadComponent(injector, route.routeConfig).pipe((0, import_operators.tap)((loadedComponent) => {
          ...
          (0, import_operators.takeUntil)(new import_rxjs.Observable((subscriber) => {
            ...
            (0, import_operators.filter)(() => !completedOrAborted && !overallTransitionState.targetRouterState),
            (0, import_operators.tap)(() => {
...
var RouterLink = class _RouterLink {
  ...
  subscription;
  /** @internal */
  onChanges = new import_rxjs2.Subject();
...
var RouterLinkActive = class _RouterLinkActive {
  ...
  /** @docs-private */
  ngAfterContentInit() {
    (0, import_rxjs2.of)(this.links.changes, (0, import_rxjs2.of)(null)).pipe((0, import_operators2.mergeAll)()).subscribe((_) => {
      this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0, import_rxjs2.from)(allLinkChanges).pipe((0, import_operators2.mergeAll)()).subscribe((link) => {
...
var PreloadAllModules = class _PreloadAllModules {
  preload(route, fn) {
    return fn().pipe((0, import_operators2.catchError)(() => (0, import_rxjs2.of)(null)));
  }
...
var RouterPreloader = class _RouterPreloader {
  ...
  setUpPreloading() {
    this.subscription = this.router.events.pipe((0, import_operators2.filter)((e) => e instanceof NavigationEnd), (0, import_operators2.concatMap)(() => this.preload())).subscribe(() => {
    });
  }
  preload() {
  ...
  processRoutes(injector, routes) {
    ...
    return (0, import_rxjs2.from)(res).pipe((0, import_operators2.mergeAll)());
  }
  preloadConfig(injector, route) {
    return this.preloadingStrategy.preload(route, () => {
      ...
      if (route.loadChildren && route.canLoad === void 0) {
        ...
        loadedChildren$ = (0, import_rxjs2.of)(null);
      }
      const recursiveLoadChildren$ = loadedChildren$.pipe((0, import_operators2.mergeMap)((config) => {
        if (config === null) {
      ...
      if (route.loadComponent && !route._loadedComponent) {
        ...
        return (0, import_rxjs2.from)([recursiveLoadChildren$, loadComponent$]).pipe((0, import_operators2.mergeAll)());
      } else {
...
var BOOTSTRAP_DONE = new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "bootstrap done indicator" : "", {
  factory: () => {
    return new import_rxjs2.Subject();
  }
});
    ...
    return locationInitialized.then(() => {
      return new Promise((resolve) => {
        ...
        injector.get(NavigationTransitions).afterPreactivation = () => {
          resolve(true);
          return bootstrapDone.closed ? (0, import_rxjs2.of)(void 0) : bootstrapDone;
        };
        router.initialNavigation();
      });
    });
...
//# sourceMappingURL=chunk-D3CC77HF.js.map
