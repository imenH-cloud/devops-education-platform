...
-- USERS/ADMINS - Les comptes existants
INSERT INTO users (id, email, "firstName", "lastName", phone, picture, address, zipcode, password, "saltRounds", token, active) VALUES
(2, 'hajerfahem@gmail.com', 'hajer', 'fahem', '75632634', 'image', 'medenine', '4100', '$2b$10$Umz9Y6nm5z7eWqPLrDrO33FJT3CHf/Ls.o3JD7tgEAxnUsLGHnW', '$2b$10$Umz9Y6nm5z7eWqPLrDrO', NULL, true)
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (id, email, "firstName", "lastName", phone, picture, address, zipcode, password, "saltRounds", token, active) VALUES
(4, 'hajerfahem2024@gmail.com', 'hajer', 'fahem', '75632634', 'image', 'medenine', '4100', '$2b$10$4b4wtCze5aBJ6ufYCk9KJusWxzcVWhPaBQswaOwoI/2.JRQOV4SqK', '$2b$10$4b4wtCze5aBJ6ufYCk9KJu', NULL, true)
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (id, email, "firstName", "lastName", phone, picture, address, zipcode, password, "saltRounds", token, active) VALUES
(5, 'admin@gmail.com', 'hajer', 'fahem', '654367', 'image', 'medenine ', '4100', '$2b$10$tcLcLfZt8Sqz3aB/uPZ30OrIi/8ngYbMXsteej4oQjxmTZO5NInnmDW', '$2b$10$tcLcLfZt8Sqz3aB/uPZ30Or', NULL, true)
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (id, email, "firstName", "lastName", phone, picture, address, zipcode, password, "saltRounds", token, active) VALUES
(6, 'imenhamada17@gmail.com', 'imen', 'Doe', '+33612345678', 'https://example.com/images/john.jpg', '123 rue de Paris', '75001', '$2b$10$r.NQjIWEqcUXP9GlrgK4MO/v.yHhMaJtjtO8QYy3t3UdZLAsQz', '$2b$10$r.NQjIWEqcUXP9GlrgK4MO', 'eyJhbGc', true)
ON CONFLICT (email) DO NOTHING;

INSERT INTO users (id, email, "firstName", "lastName", phone, picture, address, zipcode, password, "saltRounds", token, active) VALUES
(7, 'elinee@gmail.com', 'eline', 'souli', '50555555', 'hyyyyy', 'TOZEUR', '2200', '$2b$10$8MuumHmQN7QyBan5543wN5.75VV04TZecmj48Cg87h8h6it2InV0KsU', '$2b$10$8MuumHmQN7QyBan5543wN5.', NULL, true)
ON CONFLICT (email) DO NOTHING;
